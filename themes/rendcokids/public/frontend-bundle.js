...
}(_templateObject()); ///store


var storeUrl = 'https://rendcollective.com/collections/rend-co-kids/products.json';
var storeTarg = document.getElementById('store-target');
...
function onDataLoad(data) {
  ...
  var andEl = document.createElement('div');
  andEl.classList.add('store-extra', 'store-grid-item'); // andEl.classList.add('store-grid-item');
